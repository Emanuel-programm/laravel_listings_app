...
>
    ...
    @csrf
        ...
        <x-inputs.text id="title" name="title" label="Job Title" placeholder="Softwate Engineer" />

        <x-inputs.text-area id="description" name="description" label="Description" placeholder="We are seeking a skiled and motivated Software Developer.." />
        ...
        <x-inputs.text-area id="benefits" name="benefits" label="Benefits" placeholder="Health insurance ,401k ,paid time of" />
        ...
        <x-inputs.text id="address" name="address" label="Address" placeholder="123 Mani st"  />
        ...
        <x-inputs.text id="company_website" name="company_website" label="Website" type="url" placeholder="website"  />
